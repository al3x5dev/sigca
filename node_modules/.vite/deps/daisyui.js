import {
  select_default
} from "./chunk-P2FLWYYV.js";
import {
  toast_default
} from "./chunk-4F7QSDOR.js";
import {
  alert_default
} from "./chunk-B3QBNRCU.js";
import {
  addPrefix
...
// node_modules/daisyui/base/rootcolor/object.js
...
// node_modules/daisyui/components/dropdown/object.js
...
// node_modules/daisyui/components/dropdown/index.js
...
// node_modules/daisyui/components/radialprogress/object.js
...
// node_modules/daisyui/components/radialprogress/index.js
...
// node_modules/daisyui/components/stat/object.js
var object_default28 = { ".stats": { "@layer daisyui.l1.l2.l3": { "position": "relative", "display": "inline-grid", "grid-auto-flow": "column", "overflow-x": "auto", "border-radius": "var(--radius-box)" } }, ".stat": { "@layer daisyui.l1.l2.l3": { "display": "inline-grid", "width": "100%", "column-gap": "calc(0.25rem * 4)", "padding-inline": "calc(0.25rem * 6)", "padding-block": "calc(0.25rem * 4)", "grid-template-columns": "repeat(1, 1fr)", "&:not(:last-child)": { "border-inline-end": "var(--border) dashed color-mix(in oklab, currentColor 10%, #0000)", "border-block-end": "none" } } }, ".stat-figure": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "2", "grid-row": "span 3 / span 3", "grid-row-start": "1", "place-self": "center", "justify-self": "flex-end" } }, ".stat-title": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "1", "white-space": "nowrap", "color": "color-mix(in oklab, var(--color-base-content) 60%, transparent)", "font-size": "0.75rem" } }, ".stat-value": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "1", "white-space": "nowrap", "font-size": "2rem", "font-weight": 800 } }, ".stat-desc": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "1", "white-space": "nowrap", "color": "color-mix(in oklab, var(--color-base-content) 60%, transparent)", "font-size": "0.75rem" } }, ".stat-actions": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "1", "white-space": "nowrap" } }, ".stats-horizontal": { "@layer daisyui.l1.l2": { "grid-auto-flow": "column", "overflow-x": "auto", ".stat:not(:last-child)": { "border-inline-end": "var(--border) dashed color-mix(in oklab, currentColor 10%, #0000)", "border-block-end": "none" } } }, ".stats-vertical": { "@layer daisyui.l1.l2": { "grid-auto-flow": "row", "overflow-y": "auto", ".stat:not(:last-child)": { "border-inline-end": "none", "border-block-end": "var(--border) dashed color-mix(in oklab, currentColor 10%, #0000)" } } } };

// node_modules/daisyui/components/stat/index.js
...
// node_modules/daisyui/components/footer/object.js
var object_default34 = { ".footer": { "@layer daisyui.l1.l2.l3": { "display": "grid", "width": "100%", "grid-auto-flow": "row", "place-items": "start", "column-gap": "calc(0.25rem * 4)", "row-gap": "calc(0.25rem * 10)", "font-size": "0.875rem", "line-height": "1.25rem", "& > *": { "display": "grid", "place-items": "start", "gap": "calc(0.25rem * 2)" }, "&.footer-center": { "grid-auto-flow": "column dense", "place-items": "center", "text-align": "center", "& > *": { "place-items": "center" } } } }, ".footer-title": { "@layer daisyui.l1.l2.l3": { "margin-bottom": "calc(0.25rem * 2)", "text-transform": "uppercase", "opacity": "60%", "font-weight": 600 } }, ".footer-horizontal": { "@layer daisyui.l1.l2": { "grid-auto-flow": "column", "&.footer-center": { "grid-auto-flow": "row dense" } } }, ".footer-vertical": { "@layer daisyui.l1.l2": { "grid-auto-flow": "row", "&.footer-center": { "grid-auto-flow": "column dense" } } } };

// node_modules/daisyui/components/footer/index.js
...
// node_modules/daisyui/components/badge/object.js
var object_default38 = { ".badge": { "@layer daisyui.l1.l2.l3": { "display": "inline-flex", "align-items": "center", "justify-content": "center", "gap": "calc(0.25rem * 2)", "border-radius": "var(--radius-selector)", "vertical-align": "middle", "color": "var(--badge-fg)", "border": "var(--border) solid var(--badge-color, var(--color-base-200))", "font-size": "0.875rem", "width": "fit-content", "padding-inline": "calc(0.25rem * 3 - var(--border))", "background-size": "auto, calc(var(--noise) * 100%)", "background-image": "none, var(--fx-noise)", "background-color": "var(--badge-bg)", "--badge-bg": "var(--badge-color, var(--color-base-100))", "--badge-fg": "var(--color-base-content)", "--size": "calc(var(--size-selector, 0.25rem) * 6)", "height": "var(--size)" } }, ".badge-outline": { "@layer daisyui.l1.l2": { "color": "var(--badge-color)", "--badge-bg": "#0000", "background-image": "none", "border-color": "currentColor" } }, ".badge-dash": { "@layer daisyui.l1.l2": { "color": "var(--badge-color)", "--badge-bg": "#0000", "background-image": "none", "border-color": "currentColor", "border-style": "dashed" } }, ".badge-soft": { "@layer daisyui.l1.l2": { "color": "var(--badge-color, var(--color-base-content))", "background-color": "color-mix( in oklab, var(--badge-color, var(--color-base-content)) 8%, var(--color-base-100) )", "border-color": "color-mix( in oklab, var(--badge-color, var(--color-base-content)) 10%, var(--color-base-100) )", "background-image": "none" } }, ".badge-primary": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-primary)", "--badge-fg": "var(--color-primary-content)" } }, ".badge-secondary": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-secondary)", "--badge-fg": "var(--color-secondary-content)" } }, ".badge-accent": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-accent)", "--badge-fg": "var(--color-accent-content)" } }, ".badge-neutral": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-neutral)", "--badge-fg": "var(--color-neutral-content)" } }, ".badge-info": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-info)", "--badge-fg": "var(--color-info-content)" } }, ".badge-success": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-success)", "--badge-fg": "var(--color-success-content)" } }, ".badge-warning": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-warning)", "--badge-fg": "var(--color-warning-content)" } }, ".badge-error": { "@layer daisyui.l1.l2": { "--badge-color": "var(--color-error)", "--badge-fg": "var(--color-error-content)" } }, ".badge-ghost": { "@layer daisyui.l1.l2": { "border-color": "var(--color-base-200)", "background-color": "var(--color-base-200)", "color": "var(--color-base-content)", "background-image": "none" } }, ".badge-xs": { "@layer daisyui.l1.l2": { "--size": "calc(var(--size-selector, 0.25rem) * 4)", "font-size": "0.625rem", "padding-inline": "calc(0.25rem * 2 - var(--border))" } }, ".badge-sm": { "@layer daisyui.l1.l2": { "--size": "calc(var(--size-selector, 0.25rem) * 5)", "font-size": "0.75rem", "padding-inline": "calc(0.25rem * 2.5 - var(--border))" } }, ".badge-md": { "@layer daisyui.l1.l2": { "--size": "calc(var(--size-selector, 0.25rem) * 6)", "font-size": "0.875rem", "padding-inline": "calc(0.25rem * 3 - var(--border))" } }, ".badge-lg": { "@layer daisyui.l1.l2": { "--size": "calc(var(--size-selector, 0.25rem) * 7)", "font-size": "1rem", "padding-inline": "calc(0.25rem * 3.5 - var(--border))" } }, ".badge-xl": { "@layer daisyui.l1.l2": { "--size": "calc(var(--size-selector, 0.25rem) * 8)", "font-size": "1.125rem", "padding-inline": "calc(0.25rem * 4 - var(--border))" } } };

// node_modules/daisyui/components/badge/index.js
...
// node_modules/daisyui/components/validator/object.js
var object_default40 = { ".validator": { "@layer daisyui.l1.l2.l3": { "&:user-valid, &:has(:user-valid)": { '&, &:focus, &:checked, &[aria-checked="true"], &:focus-within': { "--input-color": "var(--color-success)" } }, '&:user-invalid, &:has(:user-invalid), &[aria-invalid]:not([aria-invalid="false"]), &:has([aria-invalid]:not([aria-invalid="false"]))': { '&, &:focus, &:checked, &[aria-checked="true"], &:focus-within': { "--input-color": "var(--color-error)" }, "& ~ .validator-hint": { "visibility": "visible", "color": "var(--color-error)" } } }, '&:user-invalid, &:has(:user-invalid), &[aria-invalid]:not([aria-invalid="false"]), &:has([aria-invalid]:not([aria-invalid="false"]))': { "& ~ .validator-hint": { "display": "revert-layer" } } }, ".validator-hint": { "@layer daisyui.l1.l2.l3": { "visibility": "hidden", "margin-top": "calc(0.25rem * 2)", "font-size": "0.75rem" } } };

// node_modules/daisyui/components/validator/index.js
...
var object_default44 = { ".hero": { "@layer daisyui.l1.l2.l3": { "display": "grid", "width": "100%", "place-items": "center", "background-size": "cover", "background-position": "center", "& > *": { "grid-column-start": "1", "grid-row-start": "1" } } }, ".hero-overlay": { "@layer daisyui.l1.l2.l3": { "grid-column-start": "1", "grid-row-start": "1", "height": "100%", "width": "100%", "background-color": "color-mix(in oklab, var(--color-neutral) 50%, transparent)" } }, ".hero-content": { "@layer daisyui.l1.l2.l3": { "isolation": "isolate", "display": "flex", "max-width": "80rem", "align-items": "center", "justify-content": "center", "gap": "calc(0.25rem * 4)", "padding": "calc(0.25rem * 4)" } } };
...
// node_modules/daisyui/components/collapse/index.js
...
// node_modules/daisyui/components/filter/index.js
...
// node_modules/daisyui/components/status/index.js
